...
- Imply affiliation with or endorsement by ryoku.dev

Your fork must use its own name, domain, and branding. The required
ryolink.yaml configuration enforces this by design — the software
